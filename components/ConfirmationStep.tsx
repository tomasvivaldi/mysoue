...
const ConfirmationStep: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 h-full w-full">
      <div className="rounded-md border-gray-200 bg-white px-4 md:px-12 py-8 w-[90%] sm:w-[80%] lg:w-[50%] mx-auto shadow-xl text-center">
        <h2 className="text-2xl font-semibold mb-4">List Added Successfully</h2>
        <p className="text-gray-600 mb-8">
          This list was added successfully to your Wishlists
        </p>
