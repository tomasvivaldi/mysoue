...
const AddWishlistModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  const t = useTranslations("AddWishlistModal"); // Get translations
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="relative w-[90%] sm:w-[70%] lg:w-[40%] bg-[#FDF4E5] rounded-lg shadow-lg p-8">
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold text-black mb-6">{t("newWishlist")}</h2>
          <p className="text-base text-gray-700 mb-8">{t("description")}</p>
