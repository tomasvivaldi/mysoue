    ...
    setHovered: React.Dispatch<React.SetStateAction<number | null>>;
      ...
      return (
        <div
          ...
          className={cn(
            "rounded-lg relative bg-gray-100 dark:bg-neutral-900 overflow-hidden w-full aspect-1.3h transition-all duration-300 ease-out",
...
export function FocusCards({ cards }: { cards: Card[] }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto md:px-8 w-full mt-8 sm:mt-0 ">
