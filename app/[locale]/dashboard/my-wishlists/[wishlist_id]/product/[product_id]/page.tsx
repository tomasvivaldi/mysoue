            ...
            <div className="w-full lg:w-1/2 px-4 md:px-0 flex flex-col mb-auto mt-12">
              ...
              <div className="mt-8 flex flex-col gap-4 w-full">
                ...
                <GhostButton1 
                  ...
                  href={productDetails?.affiliate_link} 
                  target="_blank"
                  disabled={loading}
                />
                <GhostButton1 
                  text={t("viewOnSharedWishlistButton")} 
                  href={`${window.location.origin}/shared/${productDetails?.wishlist_items?.[0]?.wishlists?.[0]?.shared_wishlists?.[0]?.share_token}/product/${productDetails?.id}`} 
                  target="_blank"
                  disabled={loading}
                />
