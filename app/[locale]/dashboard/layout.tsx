...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div
        className={`flex flex-1 z-0 pb-36 md:pb-12  mt-[80px] ${
          isSidebarOpen ? "md:ml-[450px]" : "md:ml-0"
        } transition-margin duration-300`}
      >

        <div className="fixed mt-[150px] pl-[80px] left-0 inset-y-0 w-full md:w-1/3  bg-white flex flex-col h-screen shadow-lg"
        >
    {/* Sidebar Menu */}
